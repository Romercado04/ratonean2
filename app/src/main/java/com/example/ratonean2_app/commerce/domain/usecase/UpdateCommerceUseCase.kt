...
class UpdateCommerceUseCase(private val commerceProvider: CommerceProvider) {
    operator fun invoke(commerce: Commerce) = commerceProvider.updateCommerce(commerce)
}